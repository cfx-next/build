...
$(combo_var_prefix)RELEASE_CFLAGS += -fno-strict-aliasing -Wno-error=strict-aliasing
endif
...
ifneq ($(combo_var_prefix),HOST_)
$(combo_var_prefix)RELEASE_CFLAGS += -Werror=strict-aliasing
else
$(combo_var_prefix)RELEASE_CFLAGS += -Wno-error=strict-aliasing
endif
